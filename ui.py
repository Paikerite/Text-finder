...
"    text-align: center;")
        ...
        self.label_for_contrast = QtWidgets.QLabel(self.ContrastGroup)
        ...
        self.lable_for_brightness = QtWidgets.QLabel(self.ContrastGroup)
        ...
        self.horizontalSlider_brightness = QtWidgets.QSlider(self.ContrastGroup)
        self.horizontalSlider_brightness.setMinimum(0)
        self.horizontalSlider_brightness.setMaximum(20)
        ...
        self.label_for_color_balance = QtWidgets.QLabel(self.ContrastGroup)
        ...
        self.horizontalSlider_color_blalance = QtWidgets.QSlider(self.ContrastGroup)
        self.horizontalSlider_color_blalance.setMinimum(0)
        self.horizontalSlider_color_blalance.setMaximum(20)
        self.horizontalSlider_color_blalance.setProperty("value", 10)
        ...
        self.pushButton_Reset_enhance = QtWidgets.QPushButton(self.ContrastGroup)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
