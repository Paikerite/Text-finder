...
"    text-align: center;")
        ...
        self.horizontalSlider_brightness.setValue(10)
        ...
        self.horizontalSlider_color_blalance.setValue(10)
        ...
        self.comboBox.addItems(["Russian", "English", "Ukrainan", "Spanish", "French", "German", "Italian", "Math(test)"])
