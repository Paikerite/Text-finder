...
"    text-align: center;")
        ...
        self.horizontalSlider_unsharmask.setMinimum(0)
        self.horizontalSlider_unsharmask.setMaximum(3)
        ...
        self.horizontalSlider_gaussianblur = QtWidgets.QSlider(self.ContrastGroupPage2)
        self.horizontalSlider_gaussianblur.setMinimum(0)
        self.horizontalSlider_gaussianblur.setMaximum(3)
        self.horizontalSlider_gaussianblur.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_gaussianblur.setObjectName("horizontalSlider_gaussianblur")
        self.verticalLayout_7.addWidget(self.horizontalSlider_gaussianblur)
        self.label_medianfilter = QtWidgets.QLabel(self.ContrastGroupPage2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_medianfilter.sizePolicy().hasHeightForWidth())
        self.label_medianfilter.setSizePolicy(sizePolicy)
        self.label_medianfilter.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignHCenter)
        self.label_medianfilter.setObjectName("label_medianfilter")
        self.verticalLayout_7.addWidget(self.label_medianfilter)
        self.horizontalSlider_medianfilter = QtWidgets.QSlider(self.ContrastGroupPage2)
        self.horizontalSlider_medianfilter.setMinimum(0)
        self.horizontalSlider_medianfilter.setMaximum(3)
        self.horizontalSlider_medianfilter.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_medianfilter.setObjectName("horizontalSlider_medianfilter")
        self.verticalLayout_7.addWidget(self.horizontalSlider_medianfilter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_medianfilter.setText(_translate("MainWindow", "Median Filter"))
